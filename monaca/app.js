myApp.controller("LoginController", function($scope, $http) {
    ...
    $scope.loginInit = function() {
        ...
        var apiToken = "D9eKNu5A0eLaZMV4E3jTzfccLRK9vifZd0dNE5yT"//localStorage.getItem("APItoken");
    ...
    $scope.saveSetting = function () {
        try{
            if($scope.domain && $scope.appId && $scope.apiId && $scope.apiToken) {
                localStorage.setItem("Domain", $scope.domain);
                localStorage.setItem("AppId", $scope.appId);
                localStorage.setItem("APIid", $scope.apiId);
                localStorage.setItem("APItoken", $scope.apiToken);
...
myApp.controller("ReaderController", function($scope, $http) {
    ...
    var checkSettings = function(){
        ...
        if(domain && appid && apiId && apiToken) {
            return true;
        }
        swal({
            title: "",
